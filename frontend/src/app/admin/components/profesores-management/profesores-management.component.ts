            ...
            <table mat-table [dataSource]="profesores" class="mat-elevation-z2">
              ...
              <ng-container matColumnDef="nombre">
                ...
                <td mat-cell *matCellDef="let profesor">
                  {{ profesor.usuario?.nombre }} {{ profesor.usuario?.apellidoPaterno }} {{ profesor.usuario?.apellidoMaterno }}
                </td>
              </ng-container>
              ...
              <ng-container matColumnDef="estado">
                ...
                <td mat-cell *matCellDef="let profesor">
                  <mat-chip [color]="profesor.activo ? 'primary' : 'warn'" selected>
...
export class ProfesoresManagementComponent implements OnInit {
  profesores: any[] = [];
  displayedColumns: string[] = ['idProfesor', 'nombre', 'email', 'horarios', 'estado', 'acciones'];
  ...
  viewHorarios(profesor: any): void {
    this.showMessage(`Ver horarios del profesor ${profesor.usuario?.nombre} - Funcionalidad en desarrollo`);
  }
